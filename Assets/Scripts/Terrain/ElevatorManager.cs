    ...
    public class ElevatorManager : MonoBehaviour {
        ...
        private void Update() {
            ...
            if (_direction == PortalDirection.Vertical) {
                ...
                _currentVelocity.x = _moveSpeed; // Movimento constante para direita
                _projectile.position += _currentVelocity * Time.deltaTime;
